...
export default async function MerlPortfolioReview(){
 ...
 return <main className="portfolio-shell">
  ...
  <footer><a href="/merl/foundations">← Return to MERL Level 1</a><p>Generated from the authenticated learner record. Quiz answers and the protected answer key are excluded.</p></footer>
  <style>{`
   ...
   @media(max-width:720px){.portfolio-shell{padding:24px 14px}.portfolio-hero{padding:24px 18px}.portfolio-hero h1{font-size:32px}.summary{grid-template-columns:1fr}.summary dl{grid-template-columns:1fr}.portfolio-shell footer{flex-direction:column}}
