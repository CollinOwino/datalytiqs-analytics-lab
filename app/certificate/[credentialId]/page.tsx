...
export default async function CertificatePage({
  ...
  const { data } = await supabase.rpc("render_credential", {
  ...
  const signatories = Array.isArray(snapshot.signatories)
  ...
  return (
    <main className="credential-page">
      ...
      <section
        ...
        aria-label="DatalytIQs Academy Certificate of Competence"
      >
        ...
        <header className="credential-brand">
          ...
          <div className="brand-centre">
            <h1>
              Datalyt<span>iQ</span>s Academy
            </h1>
            <p>
              An initiative of <b>DatalytIQs Baseline Enterprises Limited</b>
            </p>
            <small>LEARN · PRACTISE · COLLABORATE · APPLY</small>
          </div>
          <div className="brand-side right">
            Evidence
            <br />
            for Better
            <br />
        ...
        <section className="credential-body">
          ...
          <p>
            {template.achievement_statement ||
              "has successfully demonstrated the required competencies in"}
          </p>
        ...
        <section className="credential-lower">
          <div className="signatory">
            <div className="signature-box">
              {director?.signature_image_url ? (
                <img
                  src={director.signature_image_url}
          ...
          <div className="seal">
            <span>D</span>
            <small>DATALYTIQS ACADEMY</small>
          </div>

          <div className="signatory">
            <div className="signature-box">
              {facilitator?.signature_image_url ? (
                <img
                  src={facilitator.signature_image_url}
            ...
            <span>
              {facilitator?.title || "Lead Facilitator, DatalytIQs Academy"}
            </span>
          </div>
          ...
          <div className="verification-panel">
            <dl>
              <div>
                ...
                <dd>{credential.certificate_number}</dd>
              </div>
              <div>
                <dt>Date of Issue</dt>
                <dd>
                  {new Date(credential.issue_date).toLocaleDateString("en-GB", {
                    day: "2-digit",
                    month: "long",
                    year: "numeric",
                  })}
        ...
        <footer className="credential-footer">
          <div>
            <b>DatalytIQs Academy</b>
            <br />
            Nairobi, Kenya · datalytiqsacademy.com
          </div>
          <div>KNOWLEDGE · SKILLS · IMPACT</div>
          <blockquote>
            “Data is the modern oil —<br />
            we turn it into opportunity.”
          </blockquote>
        </footer>

        {revoked && (
          <div className="revoked-banner">
            {credential.status.toUpperCase()} CREDENTIAL
          </div>
        )}
      </section>
    </main>
