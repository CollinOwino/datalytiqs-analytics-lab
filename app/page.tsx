...
const courseGroups = [
  {
    ...
    courses: [
      ...
      { code: 'BI-101', title: 'Business Intelligence' },
      { code: 'DA-101', title: 'Data Analytics' },
      { code: 'DT-101', title: 'Digital Transformation & Data Systems for Executives' },
      { code: 'STAT-101', title: 'Practical Statistics' },
      { code: 'EXCEL-101', title: 'Comprehensive Excel for School Bursars — Kenya' },
      { code: 'LDR-101', title: 'Leadership for Public Officers' },
      { code: 'SM-101', title: 'Senior Management' },
    ],
  },
  {
    ...
    courses: [
      { code: 'DTQ-101', title: 'Questionnaire Design' },
      { code: 'DTQ-102', title: 'KoboToolbox Data Collection' },
      { code: 'DTQ-103', title: 'Sampling & Sample Size Determination' },
      { code: 'DTQ-104', title: 'Field Data Quality Assurance' },
      { code: 'DTQ-105', title: 'Data Cleaning in Excel' },
      { code: 'DTQ-106', title: 'Survey Data Analysis in Excel' },
      { code: 'DTQ-107', title: 'Data Visualization & Dashboarding' },
      { code: 'DTQ-108', title: 'Statistical Interpretation' },
      { code: 'DTQ-109', title: 'Data-Driven Report Writing' },
      { code: 'DTQ-110', title: 'From Evidence to Management Decisions' },
    ],
  },
]
